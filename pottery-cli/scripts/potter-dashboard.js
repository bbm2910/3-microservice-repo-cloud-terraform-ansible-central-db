...
const createPotteryItem = async (e) => {
  ...
  try {
    ...
    const response = await fetch("http://elb-402906584.us-east-1.elb.amazonaws.com/ceramics/create", options);
...
const renderVisualisation = async (id) => {
  try {
    ...
    const response = await fetch("http://elb-402906584.us-east-1.elb.amazonaws.com/sales/salesInfo", options);
    const responseData = await response.json();
    if (responseData.success) {
...
const visualiseStyleInfo = async () => {
  try {
    ...
    const response = await fetch("http://elb-402906584.us-east-1.elb.amazonaws.com/sales/styleInfo", options);
    const responseData = await response.json();
    if (responseData.success) {
...
const loadPotteryInventory = async () => {
  try {
    ...
    const response = await fetch("http://elb-402906584.us-east-1.elb.amazonaws.com/ceramics/inventory", options);
